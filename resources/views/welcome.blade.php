                        ...
                        <div class="row justify-content-center">
                            @foreach ($exhibitions as $exhibition)
                                <div class="card" style="width: 18rem;">
                                    <div class="img">
                                    <img class="card-img-top" style="filter: brightness(50%); max-height: 300px;" src="{{asset('storage/img/paintings/'.$exhibition->expositions?->first()?->paintings?->first()?->file?->name)}}"
                                                                    alt="Card image cap">
                                    </div>
